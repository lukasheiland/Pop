...
targets_posterior <- list(
  ...
  tar_target(plots_conditional_test,
             plotConditional(cmdstanfit = fit_test, parname = parname_sim, path = dir_publish, color = twocolors, themefun = themefunction)),
  tar_target(plot_contributions_test,
             plotContributions(cmdstanfit = fit_test, parname = parname_sim, path = dir_publish, color = twocolors, themefun = themefunction)),
