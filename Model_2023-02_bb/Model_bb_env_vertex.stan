...
parameters {
  ...
  vector<lower=0>[N_species] c_b_log_spread_env1_1x; // inverse bell-shaped
  vector<lower=0>[N_species] c_j_log_spread_env1_10; // inverse bell-shaped
  vector<upper=0>[N_species] g_log_spread_env1_10; // bell-shaped
  vector<upper=0>[N_species] h_log_spread_env1_10; // bell-shaped
  vector<upper=0>[N_species] r_log_spread_env1_10; // bell-shaped
  vector<lower=0>[N_species] s_log_spread_env1_10; // inverse bell-shaped
  
  vector<upper=0>[N_species] b_log_spread_env2_1x;
  vector<lower=0>[N_species] c_a_log_spread_env2_10;
  vector<lower=0>[N_species] c_b_log_spread_env2_10;
  vector<lower=0>[N_species] c_j_log_spread_env2_10;
  vector<upper=0>[N_species] g_log_spread_env2_10;
  vector<upper=0>[N_species] h_log_spread_env2_10;
...
transformed parameters {
  ...
  vector<upper=0>[N_species] g_log_spread_env2 = g_log_spread_env2_10 * 1e-1;
  vector<upper=0>[N_species] h_log_spread_env2 = h_log_spread_env2_10 * 1e-1;
...
model {
  ...
  -b_log_spread_env1   ~  normal(0, b_log_spread_hyper); // exponential(5.0); // negative!
  c_a_log_spread_env1  ~  normal(0, c_a_log_spread_hyper); // exponential(5.0);
  c_b_log_spread_env1  ~  normal(0, c_b_log_spread_hyper); // exponential(5.0);
  c_j_log_spread_env1  ~  normal(0, c_j_log_spread_hyper); // exponential(5.0);
  -g_log_spread_env1   ~  normal(0, g_log_spread_hyper); // exponential(5.0);
  -h_log_spread_env1   ~  normal(0, h_log_spread_hyper); // exponential(5.0);
  -r_log_spread_env1   ~  normal(0, r_log_spread_hyper); // exponential(5.0);
  s_log_spread_env1    ~  normal(0, s_log_spread_hyper); // exponential(5.0);
  
  -b_log_spread_env2   ~  normal(0, b_log_spread_hyper); // exponential(5.0); // negative!
  c_a_log_spread_env2  ~  normal(0, c_a_log_spread_hyper); // exponential(5.0);
  c_b_log_spread_env2  ~  normal(0, c_b_log_spread_hyper); // exponential(5.0);
  c_j_log_spread_env2  ~  normal(0, c_j_log_spread_hyper); // exponential(5.0);
  -g_log_spread_env2   ~  normal(0, g_log_spread_hyper); // exponential(5.0);
  -h_log_spread_env2   ~  normal(0, h_log_spread_hyper); // exponential(5.0);
  -r_log_spread_env2   ~  normal(0, r_log_spread_hyper); // exponential(5.0);
  s_log_spread_env2    ~  normal(0, s_log_spread_hyper); // exponential(5.0);
